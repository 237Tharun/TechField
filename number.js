...
const VIDEO_PATH = 'https://www.youtube.com/watch?v=qwHJtfEUCgE&list=PLOoogDtEDyvvLxig0poIGPWnGF74R4uxq'
const Number =()=>{
    ...
    return(
        <div className="bg6">
            ...
            <div className='bg7'>
                <h1 style={{paddingLeft:"40px"}}>Number Systems</h1><br></br><br></br>
